...
public class AuthService {
  ...
  public LoginResult login(String email, String rawPassword) {
    ...
    String accessToken = jwtProvider.generateAccessToken(user.getId(), user.getRole(), user.getLoginEmail());
  ...
  public RefreshResult refresh(String rawRefreshToken) {
    ...
    String newAccessToken = jwtProvider.generateAccessToken(userId, user.getRole(), user.getLoginEmail());
