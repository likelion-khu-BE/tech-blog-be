...
class ArchitectureTest {
    ...
    /**
     * 모듈에 아직 클래스가 없어도 테스트가 깨지지 않도록 허용.
     * 실제 클래스가 추가되면 의존성 위반을 정상 검증한다.
     */
    ...
    class ModuleBoundaryTest {
        ...
        void sessionBoardShouldNotDependOnOtherTeamModules() {
            noClasses().that().resideInAPackage("..sessionboard..")
                    .should().dependOnClassesThat()
    ...
    class CommonModuleTest {
        ...
        void commonShouldNotDependOnTeamOrContractModules() {
            noClasses().that().resideInAPackage("..common..")
                    .should().dependOnClassesThat()
                    .resideInAnyPackage("..blog..", "..qna..", "..profile..", "..sessionboard..", "..contract..")
                    .allowEmptyShould(ALLOW_EMPTY).check(classes);
        }
    }
}
