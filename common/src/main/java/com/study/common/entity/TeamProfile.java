 ...
 * 팀 프로필 엔티티.
 *
 * 멋쟁이사자처럼에서 멤버들이 모여 만든 프로젝트 팀 정보를 저장한다.
 * 어느 기수에서 만들어진 팀인지, 팀 이름·설명·프로젝트 URL을 관리한다.
 * 팀에 참여한 멤버 목록은 별도 TeamMember 엔티티에서 관리한다.
 *
 * [DB 테이블: team_profile]
 */
@Entity
...
public class TeamProfile {
  ...
  /**
   * 새 팀을 만들 때 사용하는 정적 팩토리 메서드.
   * 팀 이름과 소속 기수만 필수이고, 설명·URL은 update()로 나중에 채울 수 있다.
   */
