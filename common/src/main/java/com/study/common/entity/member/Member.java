...
import com.study.common.entity.techstack.MemberTechStack;
 ...
 * 멤버(프로필) 엔티티.
 *
 * <p>인증/계정 정보는 {@link User}에 있고, Member는 <b>프로필 도메인</b>만 담당한다. 로그인 이메일 · 비밀번호 · 승인 상태 같은 계정 속성은 여기에
 * 두지 않는다 — 중복 저장으로 인한 정합성 붕괴를 피하기 위함.
 *
