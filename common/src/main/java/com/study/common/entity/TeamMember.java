 ...
 * 팀-멤버 연결 엔티티 (중간 테이블).
 *
 * "어떤 팀에 어떤 멤버가 참여하고 있는가"를 기록한다.
 * 역할 분야는 별도 TeamMemberRole 테이블에서 관리하며, 한 팀원이 여러 역할을 가질 수 있다.
 *
 * [DB 테이블: team_member]
 */
@Entity
...
public class TeamMember {
   ...
   */
  public static TeamMember create(TeamProfile team, Member member, List<RoleInTeam> roles, boolean isLead) {
